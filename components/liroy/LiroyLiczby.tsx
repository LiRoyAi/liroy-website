...
function StatBig({ stat, inView }: { stat: typeof STATS[0]; inView: boolean }) {
  ...
  return (
    <div className="flex flex-col items-center text-center py-8 px-4 border-b border-white/5 last:border-b-0 md:border-b-0 md:border-r md:last:border-r-0">
      <span
...
export default function LiroyLiczby() {
  ...
  return (
    <section id="liczby" className="relative bg-black py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div
          ref={ref}
          className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 border border-white/5"
        >
          {STATS.map((stat) => (

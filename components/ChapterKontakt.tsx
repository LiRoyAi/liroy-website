...
export default function ChapterKontakt() {
  return (
    <section id="kontakt" className="relative min-h-screen overflow-hidden bg-black flex flex-col items-center justify-end pb-16">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center mb-12">
            <div>
              <p className="text-[#C9A84C] text-[10px] tracking-[0.4em] uppercase mb-2">Booking / Kontakt</p>
              <p className="text-white/50 text-xs tracking-widest mb-1">Dorota Liroy-Marzec</p>
              <a
